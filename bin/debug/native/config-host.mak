...
libs_softmmu=-lpixman-1   -lutil -lnuma -lbluetooth   -lncurses   -lbrlapi  -lvdeplug -luuid -lpng12   -ljpeg -lsasl2 -lSDL   -lX11   -lvte -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lpangoft2-1.0 -lpangocairo-1.0 -lgdk_pixbuf-2.0 -lpango-1.0 -lfontconfig -lfreetype -lgio-2.0 -lgobject-2.0 -lglib-2.0 -lcairo -lX11 -lXext   -lgcrypt -lgnutls   -lgtk-x11-2.0 -lgdk-x11-2.0 -latk-1.0 -lgio-2.0 -lpangoft2-1.0 -lpangocairo-1.0 -lgdk_pixbuf-2.0 -lcairo -lpango-1.0 -lfontconfig -lgobject-2.0 -lglib-2.0 -lfreetype   -lX11   -lxenstore -lxenctrl -lxenguest  -llzo2 -lsnappy -lseccomp   -lrdmacm -libverbs -lfdt
ARCH=x86_64
STRIP=strip
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=2.6.2
PKGVERSION=
SRC_PATH=/home/ubuntu/pkg/qemu-529d45e
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/ubuntu/pkg/qemu-529d45e/bin/debug/native/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
LDFLAGS=-Wl,--warn-common -Wl,-z,relro -Wl,-z,now -pie -m64 -g 
LDFLAGS_NOPIE=
LIBS+=-lm -pthread -lgthread-2.0 -lglib-2.0    -lz -lrt
LIBS_TOOLS+=-lcap-ng -lvdeplug -luuid -lgcrypt -lgnutls   
EXESUF=
DSOSUF=.so
